...
#
# Commands:
#   - kevin insult @username - Shows a tastefully insult
#
# Author:
#   AJ
...
module.exports = (robot) ->
  ...
  robot.hear /kevin insult ((@|)([\w.-]*)):?/i, (msg) ->
    insult_msg = msg.random insults
    user_to_msg = msg.match[1] 

    if msg.match[2] == "@"
      msg.send "#{user_to_msg} #{insult_msg}"
    else
      msg.send "@#{user_to_msg} #{insult_msg}"

   robot.hear /kevin compliment ((@|)([\w.-]*)):?/i, (msg) ->
    compliment_msg = msg.random compliments
    user_to_msg = msg.match[1] 

    if msg.match[2] == "@"
      msg.send "#{user_to_msg} #{compliment_msg}"
    else
      msg.send "@#{user_to_msg} #{compliment_msg}"
